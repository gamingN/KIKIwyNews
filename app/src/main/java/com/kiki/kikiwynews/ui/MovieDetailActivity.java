...
import com.kiki.kikiwynews.bean.douban.PersonBean;
import com.kiki.kikiwynews.injector.component.DaggerMovieDetailComponent;
...
import com.kiki.kikiwynews.presenter.impl.DoubanMovieDetailPresenterImpl;
import com.kiki.kikiwynews.utils.GlideUtils;
import com.kiki.kikiwynews.utils.StringFormatUtil;
import com.kiki.kikiwynews.view.HorizontalScrollView;
...
public class MovieDetailActivity extends LoadingBaseActivity<DoubanMovieDetailPresenterImpl> implements DoubanMovieDetailPresenter.View{
        ...
        for (final PersonBean personBean : castsList) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    WebViewActivity.loadUrl(MovieDetailActivity.this,personBean.getAlt(),"加载中。。。");
                }
            });
        }
