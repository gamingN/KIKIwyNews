...
public class DoubanLMAdapter extends BaseQuickAdapter<HotMovieBean.SubjectsBean,BaseViewHolder> {
    public DoubanLMAdapter(List<HotMovieBean.SubjectsBean> data) {
